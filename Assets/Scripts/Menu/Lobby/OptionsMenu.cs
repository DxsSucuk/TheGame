...
public class OptionsMenu : MonoBehaviourPunCallbacks
{
    ...
    void Awake()
    {
        ...
        dropdownRegion.SetValueWithoutNotify(dropdownRegion.options.FindIndex(0, dropdownRegion.options.Count, c => c.text == ProtectedPlayerPrefs.GetString("region", "AUTO")));
    ...
    public void regionChange()
    {
        ...
        string textValue = dropdownRegion.options[dropdownRegion.value].text;
